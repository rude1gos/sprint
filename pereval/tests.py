...
class PerevalAddedTests(APITestCase):
    def setUp(self) -> None:
        ...
        self.user = Users.objects.create(first_name='TestUser', last_name='TestUser', password='password',
                                         email='email', otc='TestUser')
        self.coord = Coords.objects.create(latitude=1.0, longitude=2.0, height=3.0)
        self.img = PerevalImages.objects.create(img='image.jpg', image_name='img')
        self.valid_payload = {
            'user': self.user.pk,
            'beauty_title': 'Test Beauty Title',
            'title': 'Test Title',
            'other_title': 'Test Other Title',
        ...
        self.valid_update = {
            ...
            "title": "Updated title",
            "other_title": "Updated other titles",
